...
export default function PostCard({ post }) {
    ...
    return (
        <a
            ...
            className="group block relative overflow-hidden transition-all duration-300 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-primary cursor-pointer"
        >
            {post.mainImage ? (
